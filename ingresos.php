...
<body>
                ...
                <div class="grafico">
                    ...
                    <div class="for">
                        <form action="php/ingreso.php" method="post">
                                <label for="nom">* Motivo del ingreso:</label>
                                <input type="text" placeholder="ejemplo: salario" name="nombre" id="nom" required>
                                <br>
                                <label for="mon">* Monto</label>
                                <input type="number" placeholder="ejemplo: 18500" name="monto" id="mon" required>
                                <br>
    ...
    <?php include("graficaingresos.php"); ?>
</body>
</html>