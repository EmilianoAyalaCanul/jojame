...
<head>
    ...
    <title>Pagos</title>
    <link rel="stylesheet" href="style.css?789">
        ...
        <div class="main"><!--contenedor principal-->
            ...
            <div class="graficos"><!--graficos-->
                <div class="grafico">
                    ...
                    <canvas id="gpagos"></canvas>
                </div>
                <div class="grafico">
                    <h2>Ingresar pago</h2>
                    <div class="for">
                        <form action="php/pagos.php" method="post">
                                <label for="nom">* Motivo del pago:</label>
                                <input type="text" placeholder="ejemplo: netflix" name="nombre" id="nom" required>
                                <br>
                                <label for="mon">* Monto</label>
                                <input type="number" placeholder="ejemplo: 1250" name="monto" id="mon" required>
                                <br>
